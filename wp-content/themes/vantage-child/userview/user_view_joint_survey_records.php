<?php
/*
Template Name: Join Specific Survey - User View
*/
...
if (is_user_logged_in()) {
    ...
    $attendance_records = $wpdb->get_results(
        $wpdb->prepare(
            "SELECT * FROM specific_joint WHERE user_id = %d ORDER BY date ASC",
            $user_id
        )
    );
...
';
        echo '<h2 id="head">My Joint Specific Assesment Records</h2>';
        ...
        echo '<a href="https://workhealthandfitnessrecord.com.au/wp-content/uploads/2024/03/Join-Survey.pdf" target="_blank"><button class="button space">View Questions</button></a>'; 

        echo '<table id="mytable" class="table-responsive">';
echo  '<thead><tr><th>Date</th><th>Lower Back</th><th>Upper Back</th><th>Neck</th><th>Right Shoulder</th><th>Left Shoulder</th><th>Right Wrist</th><th>Left Wrist</th><th>Right Hip</th><th>Left Hip</th>
          <th>Right Knee</th><th>Left Knee</th><th>Right Leg</th><th>Left Leg</th><th>Right Foot</th><th>Left Foot</th> <th>Total</th></tr></thead>'; 
