<?php
/*
Template Name: Seminar Attendance Form - Global Admin
*/
        ...
        <div class="entry-content">
            ...
            if (in_array('administrator', (array)$current_user->roles) || in_array('manager', (array)$current_user->roles)) {
                ...
                if ($users) {
                    ?>
					<h2>
						 Enter Seminar Attendance - Site Wide
			</h2>
...
<select name="staff_name" id="staff_name">
    ...
    foreach ($users as $user) {
        ...
        echo '<option value="' . esc_attr($user->user_login) . '">' . esc_html($user->display_name) . ' (' . strtolower($email_domain) . ')</option>';
    }
    ?>
</select>
